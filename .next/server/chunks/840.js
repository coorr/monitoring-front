...
class ItemService {
    ...
    revisedItem(itemData) {
        return axios__WEBPACK_IMPORTED_MODULE_0___default().post(API_URL + "revisedItem", itemData, {
            headers: {
                Authorization: (0,_user_auth_header__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(),
                "Content-Type": "multipart/form-data"
            }
    ...
    removeItem(id) {
        return axios__WEBPACK_IMPORTED_MODULE_0___default().post(API_URL + "removeItem/" + id, {
            headers: {
                Authorization: (0,_user_auth_header__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)()
            }
        });
